...
export default function HomePage() {
  ...
  return (
    <div>
      <div className="flex *:w-1/2 text-center py-4 sm:py-5 text-neutral-600 border-b border-b-slate-300 sticky top-0 *:cursor-pointer">
        ...
        >
          <div className="bg-black py-[0.1rem] sm:py-[0.13rem] rounded-full w-full"></div>
        </span>
      </div>
    </div>
  );
